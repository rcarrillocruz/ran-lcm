...
type GroupPolicySpec struct {
	...
	// Foo is an example field of GroupPolicy. Edit grouppolicy_types.go to remove/update
...
// GroupPolicy is the Schema for the grouppolicies API
...
// GroupPolicyList contains a list of GroupPolicy
